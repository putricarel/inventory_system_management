        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2>Cetak Laporan</h2>
                    <h4>(Detail Barang Stock)</h4>
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="report_barang_stock.php" class="btn btn-secondary">Kembali</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php while ($detail = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($detail['itemcode']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['itemdetail']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['itemserialno']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['pono']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['poitemno']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['podate']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['popriceunit']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['vendorcode']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['goodreceiptdate']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['warantyyear']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['assetno']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['inputdate']); ?></td>
                                                    <td><?php echo htmlspecialchars($detail['inputbyempid']); ?></td>
                                                </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                                    </table>
    ...
    $(document).ready(function() {
        $('#mauexport').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Laporan Detail Stock Barang',
                    className: 'btn-excel'
                },
                {
                    extend: 'pdf',
