                    ...
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br>
                                 <a href="summary_pengembalian.php" class="btn btn-secondary">Summary</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if ($dataAvailable) {
                                                ...
                                                SELECT * FROM pengembalian
                                                 WHERE (useddate BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY))
    OR (temporarydate BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY))
";
                                                ...
                                                while ($data = mysqli_fetch_array($ambilsemuadatamasuk)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data['givenbyempid']; ?></td>
                                                        <td><?php echo $data['usedbyempid']; ?></td>
                                                        <td><?php echo $data['status']; ?></td>
                                                        <td><?php echo $data['useddate']; ?></td>
                                                        <td><?php echo $data['temporarydate']; ?></td>
                                                        <td><?php echo $data['tilldate']; ?></td>
                                                        <td><?php echo $data['usedremark']; ?></td>
                                                        <td><?php echo $data['useddocno']; ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
