...
if ($assetType) {
    ...
    $query = "SELECT * FROM pengembalian WHERE assettype = ?"; // Penutupan tanda kutip ditambahkan
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2>Cetak Laporan</h2>
                    <h4>(Detail Barang Pengembalian)</h4>
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="summary_pengembalian.php" class="btn btn-secondary">Kembali</a>
                            </div>
                            <div class="card-body">
    ...
    $(document).ready(function() {
        $('#mauexport').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Laporan Detail Barang Pengembalian',
                    className: 'btn-excel'
                },
                {
                    extend: 'pdf',
