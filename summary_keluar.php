        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2>Cetak Laporan</h2>
                    <h4>(Summary Barang Keluar)</h4>
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                 <a href="report_barang_keluar.php" class="btn btn-secondary">Kembali</a>
                                            ...
                                            if ($dataAvailable) {
                                                while ($data = mysqli_fetch_array($ambilsemuadatamasuk)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-warning" onclick="window.location.href='detail_keluar.php?id=<?php echo htmlspecialchars($data['assettype']); ?>'">
                                                                Detail
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    $(document).ready(function() {
        $('#mauexport').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Laporan Summary Barang Keluar',
                    className: 'btn-excel'
                },
                {
                    extend: 'pdf',
