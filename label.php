...
<head>
 ...
 <link href="jscss/bootstrap4.5.2.0min.css" rel="stylesheet" />
    ...
    <script src="jscss/JsBarcode3.11.0.all.min.js"></script>
    <style>
        @media print {
            .print-area {
                width: 7cm; /* Set width for 4-inch print */
        ...
        .barcode-container {
            ...
            margin-bottom: 1px; /* Spacing below the barcode */
        }
        .logo-barcode {
            display: flex;
            flex-direction: column; /* Stack logo and barcode vertically */
            align-items: left; /* Center items */
            margin-right: 5px; /* Space between logo/barcode and details */
        }
        .asset-details {
            display: flex;
        ...
        .detail-item {
            margin-bottom: 0.5px; /* Space between each detail item */
        }
        .detail-label {
                                    ...
                                    <div class="barcode-container">
                                        ...
                                        <div class="asset-details">
                                            <div class="detail-item">
                                                <span class="detail-label">Asset No:</span> <?php echo htmlspecialchars($detail['assetno']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Item Code:</span> <?php echo htmlspecialchars($detail['itemcode']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Item Detail:</span> <?php echo htmlspecialchars($detail['itemdetail']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Po No:</span> <?php echo htmlspecialchars($detail['pono']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Po Price Unit:</span> <?php echo htmlspecialchars($detail['popriceunit']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Vendor Code:</span> <?php echo htmlspecialchars($detail['vendorcode']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Good Receipt Date:</span> <?php echo htmlspecialchars($detail['goodreceiptdate']); ?>
                                            </div>
                                            <div class="detail-item">
                                                <span class="detail-label">Warranty Year:</span> <?php echo htmlspecialchars($detail['warantyyear']); ?>
                                            </div>
                                        </div>
                                    </div>
                                <?php else: ?>
