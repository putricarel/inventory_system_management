                    ...
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <br>
                                <a href="summary_rusak.php" class="btn btn-secondary">Summary</a>
                                    ...
                                    <table class="table table-bordered" id="mauexport" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if ($dataAvailable) {
                                                $query = "
                                                SELECT * FROM rusak
                                                WHERE returnfaileddate BETWEEN '$mulai' AND DATE_ADD('$selesai', INTERVAL 1 DAY)
                                                ";
                                                ...
                                                while ($data = mysqli_fetch_array($ambilsemuadatamasuk)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data['returnreceiveby']; ?></td>
                                                        <td><?php echo $data['returnfaileddate']; ?></td>
                                                        <td><?php echo $data['statusobsolate']; ?></td>
                                                        <td><?php echo $data['remarkapprovalreject']; ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
