...
$query = "
SELECT obsolatedocno, COUNT(assetno) AS jumlah FROM masuk
WHERE obsolateapproval = 'Approved'  -- Pastikan obsolateapproval bernilai 'Approved'
AND obsolatedocno IS NOT NULL  -- Pastikan obsolatedocno tidak null 
GROUP BY obsolatedocno";
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2>Cetak Laporan</h2>
                    <h4>(Summary Barang Obsolate)</h4>
                    <div class="data-tables datatable-dark">
                        <div class="card mb-4">
                            <div class="card-header">
                                 <a href="rusak.php" class="btn btn-secondary">Kembali</a>
                                        ...
                                        <tbody>
                                            ...
                                            if ($dataAvailable) {
                                                while ($data = mysqli_fetch_array($ambilsemuadatamasuk)) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo htmlspecialchars($data['obsolatedocno']); ?></td>
                                                        <td><?php echo htmlspecialchars($data['jumlah']); ?></td>
                                                        <td>
                                                            <button type="button" class="btn btn-warning" onclick="window.location.href='detail_obsolate.php?id=<?php echo htmlspecialchars($data['obsolatedocno']); ?>'">
                                                                Detail
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    $(document).ready(function() {
        $('#mauexport').DataTable({
            ...
            buttons: [
                {
                    extend: 'excel',
                    title: 'Laporan Summary Barang Obsolate',
                    className: 'btn-excel'
                },
                {
                    extend: 'pdf',
